...
export const AdvertiserSidebar = ({ isMobile = false, onNavigate }: AdvertiserSidebarProps) => {
  ...
  return (
    <>
      {/* Hamburger Button when collapsed (desktop only) */}
      {!isMobile && collapsed && (
        <div className="fixed top-4 left-4 z-50">
          <Button
            ...
            className="h-10 w-10 rounded-lg bg-card shadow-md border-border/50 hover:bg-secondary"
          >
      ...
      {(!collapsed || isMobile) && (
        ...
        >
          ...
          <div className="p-3 border-t border-border/50">
            <button
              className="w-full flex items-center gap-3 h-12 px-3 rounded-xl transition-all duration-300 group hover:bg-destructive/10"
